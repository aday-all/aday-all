echo -E " "
echo -E "READY FOR DATA CHANGES"
echo -E " "
echo -E "CLEARING CACHE"
rm -rf /storage/emaulated/0/Android/data/com.pubg.krmobile/cache
rm -rf /storage/emaulated/0/Android/data/com.pubg.krmobile/files/tbslog
rm -rf /storage/emaulated/0/Android/data/com.pubg.krmobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Logs
rm -rf /storage/emaulated/0/Android/data/com.pubg.krmobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Paks/filelist.json
rm -rf /storage/emaulated/0/Android/data/com.pubg.krmobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Paks/puffer_res.eifsbk
rm -rf /storage/emaulated/0/Android/data/com.pubg.krmobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Paks/apollo_reslist.flist
echo -E "        100%"
echo -E "==================="
echo -E " ANTI-REPORT = ON "
echo -E "==================="
echo -E " A C T I V A T E D "
echo -E "==================="
echo -E "Done"
sleep 1
echo -E "Log Cleaner Start" 
while true; do
sleep 10
...
rm -rf /data/media/0/Android/data/com.pubg.krmobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/ImageDownload
...
rm -rf /data/media/0/Android/data/com.pubg.krmobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Paks/filelist.json
...
echo -E "Done"
echo -E "Log Clean Successfully 🖕🏻Now Fuck"
done
echo -E "CHANNEL - @adayall"
echo -E "Developer - @adayall"